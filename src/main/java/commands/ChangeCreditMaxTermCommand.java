...
public class ChangeCreditMaxTermCommand implements Command{
    ...
    public void execute(){
        ...
        System.out.println("Enter new maximal term");
        int newMaxTerm = console.nextInt();
        credit.setMaximalTerm(newMaxTerm);
        System.out.println("Maximal term was succesfully changed!");
    }
    @Override
